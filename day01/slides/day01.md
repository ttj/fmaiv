...
- **AWS, by contrast, continuously formally verifies its crypto** — s2n-TLS's crypto kernels are checked with SAW proofs on every commit, and in March 2026 AWS added a HOL Light–verified AES-XTS implementation to its s2n-bignum library.
